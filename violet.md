...
> [!Warning]
> **Retrofit Dynamic Partitions based builds are in v6.0 or above**

### v6.0 
```
- violet: Initial Release of Android 16 for violet
...
> * Recovery Link : [Tap here for link](https://projectelixiros.com/download)
