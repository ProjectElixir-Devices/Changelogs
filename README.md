...
### v6.0 | Android 16 | Baklava
```
- Introducing Project Elixir now based on Android 16 シ
- Merged latest Security patch from Google
- CTS and play integrity passes and banking apps are working fine
- Exclusive : Added Revamped Automated depth clocks
- Exclusive : Automatic depth clock: No need to set subject separately
- Exclusive :Re-Designed Whole UI adapt for Android 16
- Added brand new QS panel based on Android 16
- Added Re-Designed Volume Panel
- Added support for Sidebar & LMOFreeform service
- Added App lock and face unlock
- Added a lot of basic options for statusbar, qs, lockscreen
- Added theming section for icon, font, slider, etc
- Added Re-Designed Seekbar
- Added a hell lot of stuff checkout full changelog
- Much More, Try by yourself
```

> [!Important]
> - For fixing play integrity: Open Updater, tap and hold the update play integrity option and then it will download and update automatically. After that clear play store data and reboot once.
> - You should make always a backup before doing dirty or clean flash to avoid data loss or bugs
> - Changing Android version or an QPR update requires clean flash
> - If you find any bug, please do report us here and make sure to provide proper logs

<br>

<h3 align="center">- Below changes are from Android 15 </h3> 
<br>

<p align="center">
  <img src="https://github.com/ProjectElixir-Devices/Changelogs/blob/vany/res/elixir-a15banner.png" />
</p
...
- Merged latest Security patch from Google
- CTS and play integrity passes and banking apps are working fine
- Re-Designed Volume Panel
- Re Designed Automated depth clock section for ease
- Added weather to custom clock
- overlay: Add NothingOS 3.0 lockscreen clock fonts
- overlays: Add MotoMilkyStacked lockscreen font
- SystemUI: Add QS Header Image customization
- SystemUI: Add ongoing action chip toggle setting
- SystemUI: Add QS Panel Style 
- SystemUI: Add A11 QS UI Style 
- SystemUI: Allow to change QS tile label text size 
- base: Introduce PowerOffAlarmService
- Battery styles: Add OneUI 7 battery style
- Optional haptic feedback on back gesture
- Allow to hide arrow for back gesture
- SystemUI: Redesign charging ripple
- Settings: Dashboard: Switch back to elixir dashboard icons
- Settings: Dashboard: Icons Follow system accent
- Added card layout to missing pages
- Essence: Implement search button play/pause
- Essence: Fix data usage in QS
- Essence: Add sidebar settings
- Switched to our own launcher aka BREW launcher
- Added a hell lot of stuff checkout full changelog
- Much More, Try by yourself
```

> [!Important]
> - For fixing play integrity: Open Updater, if there is any update for play integrity then it will download and update automatically. After that clear play store data and reboot once
...
- Re Designed Automated depth clock section for ease
- Added Re-Designed Seekbar
- Added advance monet options in Essence
- Added Lockscreen Charging
- Added support for window ignore secure
- Added support for application downgrade 
- Added disabling ripple effect on unlock
...
- Added an option to disable Data Disabled Indicator icon 
- Added toggle to use 4G icon instead of LTE 
- Added all basic needed QS Tiles specially data switch tile
- Added per-app volume support
- Added Adaptive Playback 
- Added Wi-Fi & Bluetooth timeout feature
- Added Smart 5G service
- Added wifi standard icon feature 
...
- Added status bar battery icon Styling
- Added Network traffic mode for status bar 
- Added Fingerprint authentication vibration
- Added support for GameSpace
- Added edge light customizations 
- Added toggle to hide screen capture status from apps 
- Added toggle to Hide ADB and developer setting enable status
- Added app lock 
- Added Incall vibration options 
- Added Phone ringtone setting for Multi SIM device
- Added FaceSense service
- Added toggle for secure tiles on keyguard 
- Added toggle to show Ambient instead of fully waking
- Added toggle to schedule always on display 
- Added toggle to notification counter
- Added toggle to Use app icons for notifications in statusbar
- Added Statusbar clock customizations
- Added toggle to disable private DNS for VPN 
- Added double tap to sleep on lockscreen 
- Added Statusbar clock background chip 
- Added three fingers swipe actions 
- Added support for LMOFreeform service
- Added toggle for daily data usage in QS footer
- Added back increasing ring feature 
- Added toggle to spoof for Games for fps
- Added option to launch statusbar tuner
- Added customizing volume stream steps 
- Added back UDFPS animation
- Added back UDFPS icons
- Added toggling screen off FOD 
- Added Flashlight Strength Tile
- Redesign and animate Battery and storage progress bars
- Enable and tune new keyguard user switcher
- Fixed Android Auto issues
- Bring back Theming in Essence > Themes
- Re-Designed Volume Panel
```
...
- Exclusive : Added Revamped Automated depth clocks
- Exclusive : Automatic depth clock: No need to set subject separately
- Exclusive : Re-Designed Whole UI adapt for Android 15
- Exclusive: Essence: Add randomization support for udfps animation
- Exclusive : Added few more depth clock styling like HyperOS [wip]
- Circle to search works by default
- Essence: Added Battery style options
- Added App lock and face unlock
- Essence: Add monet customization with granular control over shades
- Essence: Add status bar lyric
- Added a lot of basic options for statusbar, qs, lockscreen
- Added theming section for icon, font, slider, etc
- Default launcher is Pixel launcher
- Added a hell lot of stuff checkout full changelog
- Much More, Try by yourself
```
...
- Bump to v4.1 and updated default wallpaper
- Much More, Try by yourself
- Much more 
```
> [!Important]
